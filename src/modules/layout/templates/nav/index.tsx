...
export default async function Nav() {
  ...
  return (
    <>
      <section className="z-30 sticky top-[0] left-[0] w-full [transition:top_0.5s]">
        <div className="header-wrap">
          <div className="head-skinny-wrap">
            <section className="relative">
              <div className="navigation-head-skinny-wrap">
                <div className="navigation-head flex font-value items-center px-[1.06667rem] justify-between bg-[#ffffff] z-[31] h-[clamp(3.73333rem,calc(3.73333rem+(16)*((100vw-1200px)/(1440-1200))),4.8rem)] [@media(min-width:780px)]:h-[clamp(4.26667rem,calc(4.26667rem+(8)*((100vw-1200px)/(1440-1200))),4.8rem)] [@media(min-width:1200px)]:px-[clamp(1.6rem,calc(1.6rem+(56)*((100vw-428px)/(1920-428))),5.33333rem)]">
                  ...
                  {/* <button
                    type="button"
                    className="navigation-hamburger w-10 h-10 [@media(min-width:780px)]:w-12 [@media(min-width:780px)]:h-12 [@media(min-width:1200px)]:hidden focus-visible:outline-[#205ecc_auto_1px]"
                  ...
                  <div className="main-navigation-wrap hidden [@media(min-width:1200px)]:inline-flex [@media(min-width:1200px)]:h-full [@media(min-width:1200px)]:w-[calc(50%-5.6rem)]">
                    <nav
                      className="main-navigation-links main-navigation-links-left [@media(min-width:1200px)]:inline-flex [@media(min-width:1200px)]:items-center [@media(min-width:1200px)]:h-full"
                      role="navigation"
                      aria-label="main navigation"
                    >
                      <ul className="flex list-none ml-0 h-full whitespace-nowrap">
                        <li>
                          <button
                            className="text-[0.93333rem] uppercase font-bold text-[#153a5b] tracking-[0.1rem] leading-[1.33333rem] h-full flex flex-col justify-center [transition:color_0.5s_ease-in-out] pr-[clamp(2.13333rem,calc(2.13333rem+(8)*((100vw-1200px)/(1920-1200))),2.66667rem)] focus-visible:outline-[#205ecc_auto_1px] after:content-[''] after:w-[0] after:block after:h-[2px] after:[transition:width_0.2s_ease-in-out] hover:after:bg-[#153a5b] hover:after:w-full active:after:bg-[#153a5b] active:after:w-full"
                            aria-label="Shop all"
                            tabIndex={0}
                            role="button"
                          >
                  ...
                  <div className="navigation-mobile-account-cart flex items-center gap-[0.53333rem] [@media(min-width:780px)]:gap-[1.06667rem] [@media(min-width:1200px)]:hidden">
                    <a
                      className="navigation-account flex w-10 h-10 ml-auto items-center justify-center relative"
                      href="/user/sign-in"
                    >
                      <svg
                        width="40"
                    ...
                    {/* <button
                      className="navigation-cart flex w-10 h-10 ml-auto items-center justify-center relative"
                  ...
                  <div className="main-navigation-wrap main-navigation-wrap-right hidden [@media(min-width:1200px)]:inline-flex [@media(min-width:1200px)]:h-full [@media(min-width:1200px)]:w-[calc(50%-5.6rem)] justify-end">
                    <nav className="main-navigation-links main-navigation-links-right inline-flex items-center h-full">
                      <ul className="flex list-none ml-0 h-full [&_button:last-of-type]:mr-0 [&_a:last-of-type]:mr-0">
                        <li className="">
                          <a
                            className="text-[0.93333rem] uppercase font-bold text-[#153a5b] tracking-[0.1rem] leading-[1.33333rem] h-full flex flex-col justify-center [transition:color_0.5s_ease-in-out] pr-[clamp(2.13333rem,calc(2.13333rem+(8)*((100vw-1200px)/(1920-1200))),2.66667rem)] focus-visible:outline-[#205ecc_auto_1px] after:content-[''] after:w-[0] after:block after:h-[2px] after:[transition:width_0.2s_ease-in-out] hover:after:bg-[#153a5b] hover:after:w-full active:after:bg-[#153a5b] active:after:w-full"
                            href="/technology"
                        ...
                        <li className="icon-item account-item flex items-center justify-center">
                          <a
                            className="navigation-account group pr-0 mr-[clamp(2.13333rem,calc(2.13333rem+(8)*((100vw-1200px)/(1920-1200))),2.66667rem)] w-10 h-10 [transition:color_0.5s_ease-in-out] focus-visible:outline-[#205ecc_auto_1px] after:!hidden after:content-[''] after:w-[0] after:h-[2px] after:[transition:width_0.2s_ease-in-out] hover:after:bg-[#153a5b] hover:after:w-full active:after:bg-[#153a5b] active:after:w-full"
                            href="/user/sign-in"
                          >
                            <svg
                              className="w-[40px] h-[40px] rounded-[50%] bg-[#ffffff] [transition:background_0.3s_ease] group-hover:bg-[#f4f6fa]"
                              width="40"
                              height="40"
                              viewBox="0 0 40 40"
                              fill="none"
                            ...
                            >
                              <path
                                className="[transition:opacity_0.3s_ease] group-hover:opacity-100"
                                opacity="0.64"
                                d="M22.5 16C22.5 15.125 22 14.3125 21.25 13.8438C20.4688 13.4062 19.5 13.4062 18.75 13.8438C17.9688 14.3125 17.5 15.125 17.5 16C17.5 16.9062 17.9688 17.7188 18.75 18.1875C19.5 18.625 20.4688 18.625 21.25 18.1875C22 17.7188 22.5 16.9062 22.5 16ZM16 16C16 14.5938 16.75 13.2812 18 12.5625C19.2188 11.8438 20.75 11.8438 22 12.5625C23.2188 13.2812 24 14.5938 24 16C24 17.4375 23.2188 18.75 22 19.4688C20.75 20.1875 19.2188 20.1875 18 19.4688C16.75 18.75 16 17.4375 16 16ZM14.5312 26.5H25.4375C25.1562 24.5312 23.4688 23 21.4062 23H18.5625C16.5 23 14.8125 24.5312 14.5312 26.5ZM13 27.0938C13 24 15.4688 21.5 18.5625 21.5H21.4062C24.5 21.5 27 24 27 27.0938C27 27.5938 26.5625 28 26.0625 28H13.9062C13.4062 28 13 27.5938 13 27.0938Z"
                                fill="#153A5B"
                              ></path>
                        ...
                        <li className="icon-item flex items-center justify-center">
                          <button
                            className="navigation-cart group w-10 h-10 pr-0 mr-[clamp(2.13333rem,calc(2.13333rem+(8)*((100vw-1200px)/(1920-1200))),2.66667rem)] [transition:color_0.5s_ease-in-out] focus-visible:outline-[#205ecc_auto_1px] after:!hidden after:content-[''] after:w-[0] after:h-[2px] after:[transition:width_0.2s_ease-in-out] hover:after:bg-[#153a5b] hover:after:w-full active:after:bg-[#153a5b] active:after:w-full"
                            aria-label="Open cart slide out"
                          >
                            <svg
                              className="w-[40px] h-[40px] rounded-[50%] bg-[#ffffff] [transition:background_0.3s_ease] group-hover:bg-[#f4f6fa]"
